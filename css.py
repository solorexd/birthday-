...
/* Original h1 style repurposed for first message line: "Happy" */
.first--slide .slide--content h1.message-line-1{
	position: relative;
...
/* Original h2 style repurposed for the Name line */
.first--slide .slide--content h2.name-line{
	position: relative;
	color:#fcbb5e;
	font-size:4em;
	line-height: 1em;
...
/* New style for the second message line: "on your [Age]th Birthday!" */
.first--slide .slide--content h3.message-line-2{
	position: relative;
	color:#d8d0be;
	font-size: 2em;
	line-height: 1em;
	margin-top: 0.5em; /* Adjusted to fit below the name */
	opacity: 0;
	animation:  firstSlideTextTwo 500ms ease 700ms 1 forwards; /* Delayed slightly */
}

/* Highlight the Age number */
.first--slide .slide--content .age-line {
	color:#fcbb5e;
}

/* New style for the custom message */
.first--slide .slide--content p.custom-message{
	position: relative;
	color:#d8d0be;
	font-size: 1.5em;
	line-height: 1.2em;
	margin-top: 1em;
	opacity: 0;
	text-transform: none; /* Allow lower case text for the message */
	animation:  firstSlideTextTwo 500ms ease 1050ms 1 forwards; /* Further delayed */
}
...
@keyframes firstSlideTextTwo{
	from{
		opacity: 0;
		top: -1.6em; /* This will be the original animation start point for H2, new elements will just start at an arbitrary 'top' to fade in/move to 0em */
	}
	to{
		opacity: 1;
		top: 0em;
